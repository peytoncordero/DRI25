...
When filesystem became a generalized name for the structure of the information in the computers (around the 1960s), only a limited audience had access to computers. It was pretty common for scholars and researchers to keep printed files and folders in the physical space and visit physical archives and libraries as part of their activities. In other words, the users of the computers in the 1960s were quite familiar with the metaphor of files and folders; we can also expect them to have a sense of how to store information in ways they could easily retrieve it. Additionally, thinking of hardware, when computers were the size of a room, people went to share the physical space and store information, just as the library of our metaphor, and a shared room requires as much organization as possible. 

The ways in which people relate to the filesystem has changed over time. Computers became smaller devices that anyone -with the purchasing power- could take home. The new users might have been more distant to the metaphor of a hierarchical system to organize information. However, as physical files and folders were still pretty common, they could relate to these objects. And even if the hierarchical structure of the metaphor might have not being so clear, organizing the information continued to be a need as computers were usually shared by families or other groups. Later on, computers became even smaller and many users started to have one, 'their very own (portable digital) room'. And it is no secret that not everyone keeps their room tidy! 

Going back to the metaphor, now libraries store digital collections. We can visit them without the physical experience of the building, the shelves, and the information organized hierarchicaly in the space. And, as we move in that direction, the filesystem is not so much a metaphor we live by. 

That distance, in fact, challenges those learning about computers, as you can read in the essay [File Not Found](https://www.theverge.com/22684730/students-file-folder-directory-structure-education-gen-z). This makes sense as we are also related to new structures of information in our everyday practices, as  the [Arium: Beyond the Desktop Metaphor](https://kilthub.cmu.edu/articles/thesis/Arium_Beyond_the_Desktop_Metaphor_A_new_way_of_navigating_searching_and_organizing_personal_digital_data/6723005) elaborates. 

As for the command line, understanding the hierarchical structure of the filesystem continue to be an esential task to be able to interact with the computer and give it commands!
