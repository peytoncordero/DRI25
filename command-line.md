...
The relationship of people with the filesystem -and, particularly, with the idea of a hierarchical system to organize information- might have change over time. When computers became smaller devices and anyone with the purchasing power could take them home, the metaphor started somehow to become more distant. However, while physical files and folders were still pretty common, new users could still relate the metaphor to these objects. Even if the hierarchical structure was left out of the meaning, organizing the information continued to be a need as computers were usually shared by families or other groups.
