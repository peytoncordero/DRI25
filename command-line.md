...
The ways in which people relate to the filesystem has changed over time. Computers became smaller devices that anyone -with the purchasing power- could take home. The new users might have been more distant to the metaphor of a hierarchical system to organize information. However, as physical files and folders were still pretty common, they could relate to these objects. And even if the hierarchical structure of the metaphor might have not being so clear, organizing the information continued to be a need as computers were usually shared by families or other groups.

Later on, as computers became smaller, many users started to have one that became 'their very own (portable digital) room'. And not everyone keeps their room tidy! We can add that there have been changes and people store and retrieve more digital than physical information, thus the metaphor and our experience with the archive becomes more distant. We suggest reading [File Not Found: A generation that grew up with Google is forcing professors](https://www.theverge.com/22684730/students-file-folder-directory-structure-education-gen-z) to rethink their lesson plans. 
