...
Annette Markham in ["OKCupid data release fiasco: It’s time to rethink ethics education"](https://annettemarkham.com/2016/05/okcupid-data-release-fiasco-its-time-to-rethink-ethics-education/) asserts that ethical digital reseach is not confined to nor should it be only based on top down institutional structures nor the compliance to a set of check lists. Ethical digital research is a methododlogy dependent on reflection, awarness of the debates and concerns in our respective fields, and accountability for the choices we make at each stage of our research. Ethics is a methodology and given the precarious nature of digital research and data we need to use a "what if" approach that will help us evaluate "the possible or probable impact, rather than the prevention of the impact." This "impact approach" helps us expand our ethical imagination and consider ethics beyond compliance. 
