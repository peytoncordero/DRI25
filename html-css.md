...
1. Open your terminal. To do this: On Mac, press `⌘ + space` (**command** and **space**), then type `Terminal`. Click the `Terminal` icon <img src="/images/html-css/Terminaliconmac.png" alt="Mac Terminal icon" style="width:25px;height=auto;">. On Windows, press `Windows + R` (**Windows** and **R**) to open up the **Run** dialogue box. Then type `wt` and click `Ok`.
